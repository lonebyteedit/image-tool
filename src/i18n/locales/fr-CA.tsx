...
const frCA: Translation = {
    static: {
        index_lang: 'fr-CA',
        index_dir: 'ltr',
        index_title: "Image Tool - Outil de conversion d'images avancé",
        index_description: "Un outil en ligne professionnel et gratuit pour la compression, le redimensionnement et la conversion de formats d'images. Il prend en charge la conversion mutuelle entre JPG, PNG, WebP et AVIF, et peut convertir le format HEIC vers ces derniers. Tout le traitement s'effectue localement dans votre navigateur — vos fichiers ne sont jamais téléversés, garantissant une confidentialité et une sécurité totales de vos données.",
        optionsExplanation: {
            title: "Guide des options",
            subtitle: "Comprenez la fonction de chaque option pour optimiser les résultats de conversion de vos images.",
            options: [
                {
                    id: "quality-option",
                    title: "Qualité de compression",
                    description: <>
                        <p>Cette option s'applique uniquement lorsque le format de sortie est <strong>JPG</strong>, <strong>WebP (avec pertes)</strong> ou <strong>AVIF (avec pertes)</strong>.</p>
                        <p>Une valeur plus basse produit un fichier plus petit, mais réduit la qualité de l'image. La valeur recommandée de <strong>75</strong> offre un excellent équilibre entre la taille du fichier et la qualité.</p>
                        <p>Si le fichier demeure trop volumineux après la compression, essayez de réduire la résolution, ce qui est souvent plus efficace pour diminuer la taille du fichier.</p>
                    </>
                },
                {
                    id: "size-option",
                    ...
                    description: <>
                        <p>Réduisez la résolution de l'image en pourcentage tout en conservant le ratio d'aspect original. <strong>100%</strong> conserve les dimensions d'origine.</p>
                        <p>La réduction de la résolution peut diminuer la taille du fichier de façon <strong>significative</strong>. Si vous n'avez pas besoin de la haute résolution originale, c'est souvent la <strong>méthode la plus efficace</strong> pour alléger le fichier.</p>
                ...
                },
                {
                    ...
                    description: <>
                        <p>Choisissez le format de sortie de l'image. Chaque format possède ses propres avantages et cas d'utilisation.</p>
                        ...
                        <p>Vous pouvez également sélectionner manuellement un format ci-dessous selon vos besoins. Voici un guide détaillé pour chaque option :</p>

                        <p>
                            <strong>JPG</strong> : Le format d'image le plus populaire, bien qu'il ne prenne pas en charge la transparence. Par rapport à un <strong>PNG non compressé</strong>, il réduit la taille du fichier d'environ <strong>90%</strong>. Avec un paramètre de qualité de <strong>75</strong>, la perte de qualité est <strong>quasiment imperceptible</strong>. Si vous n'avez pas besoin de transparence <strong>(ce qui est le cas pour la plupart des photos)</strong>, la conversion en <strong>JPG</strong> est habituellement le meilleur choix.
                        </p>

                        <p>
                            <strong>PNG (avec pertes)</strong> : Prend en charge la transparence avec une légère perte de qualité. Réduit la taille du fichier d'environ <strong>70%</strong> par rapport à un <strong>PNG non compressé</strong>. À choisir uniquement si vous avez besoin de la transparence au format PNG. Autrement, le <strong>JPG</strong> offre une <strong>meilleure qualité pour une taille plus petite</strong> (sans transparence), et le <strong>WebP (avec pertes)</strong> fournit une <strong>meilleure qualité, une taille plus réduite et la transparence</strong>, ce qui en fait une meilleure solution si le format PNG n'est pas une exigence stricte.
                        </p>

                        <p>
                            <strong>PNG (sans perte)</strong> : Prend en charge la transparence sans aucune perte de qualité. Réduit la taille du fichier d'environ <strong>20%</strong> par rapport à un <strong>PNG non compressé</strong>. Cependant, si le <strong>format PNG n'est pas obligatoire</strong>, le <strong>WebP (sans perte)</strong> est un meilleur choix, car il produit des fichiers plus légers.
                        </p>

                        <p>
                            <strong>WebP (avec pertes)</strong> : Prend en charge la transparence avec une légère perte de qualité. Réduit la taille du fichier d'environ <strong>90%</strong> par rapport à un <strong>PNG non compressé</strong>. C'est une excellente alternative au <strong>PNG (avec pertes)</strong>, offrant une meilleure qualité et des fichiers plus petits. Note : Le format WebP n'est pas compatible avec certains appareils plus anciens.
                        </p>

                        <p>
                            <strong>WebP (sans perte)</strong> : Prend en charge la transparence sans perte de qualité. Réduit la taille du fichier d'environ <strong>50%</strong> par rapport à un <strong>PNG non compressé</strong>, ce qui en fait un remplacement supérieur au <strong>PNG (sans perte)</strong>. Note : Le format WebP n'est pas compatible avec certains appareils plus anciens.
                        </p>

                        <p>
                            <strong>AVIF (avec pertes)</strong> : Prend en charge la transparence avec une légère perte de qualité. Successeur de <strong>WebP</strong>, il offre un taux de compression encore plus élevé, réduisant la taille du fichier d'environ <strong>94%</strong> par rapport à un <strong>PNG non compressé</strong>. En tant que format de pointe, l'AVIF offre une excellente qualité pour une très petite taille. Cependant, sa compatibilité avec les navigateurs et les appareils est encore limitée. Ce format est idéal pour les utilisateurs avancés ou lorsque vous êtes certain que les appareils cibles le prennent en charge.
                        </p>
                        <p>
        ...
        themeToggle_title: "Changer le thème"
    },
    interactive: {
        ...
        store_conversionFailedNotification: "La conversion a échoué : {fileName}",
        store_unsupportedFileTypeNotification: "Format non pris en charge, image supprimée : {fileName}",
        store_fileReadErrorNotification: "Lecture du fichier impossible, image supprimée : {fileName}",
        store_reconvertingNotification: "Reconversion en cours : {fileName}",
        ...
        previewSection_placeholder: "Aucune image pour le moment.",
        previewSection_statusPending: "En attente",
        previewSection_statusConverting: "Conversion en cours...",
        previewSection_statusFailed: "Échec. Veuillez rafraîchir la page et réessayer.",
        previewSection_statusCompleted: "Terminé",
        previewSection_noCompletedFilesNotification: "Aucune image terminée à télécharger.",
        ...
        previewSection_downloadingFileNotification: "Téléchargement en cours : {fileName}",
        previewSection_originalSizeLabel: "Taille originale :",
        previewSection_convertedSizeLabel: "Nouvelle taille :",
        previewSection_downloadTitle: "Télécharger",
        previewSection_previewTitle: "Aperçu",
        previewSection_deleteTitle: "Supprimer",
        previewSection_comparisonTab: "Comparaison",
        previewSection_settingsTab: "Paramètres",
        previewSection_originalImageLabel: "Image originale",
        ...
        previewSection_viewLargerButton: "Afficher dans un nouvel onglet",
        ...
        globalControls_restoreDefaultsButton: "Rétablir les paramètres par défaut",
        globalControls_noImagesNotification: "Veuillez d'abord ajouter des images.",
        globalControls_reconvertingAllNotification: "Reconversion de {imageCount} images avec les paramètres globaux",
        globalControls_restoredNotification: "Les options ont été rétablies par défaut.",
        ...
        addArea_tips: "*Vous pouvez ajouter plusieurs images à la fois.",
